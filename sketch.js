...
function setup() {
 ...
 //invisibleground2.visible=false;
  ...
  ground = createSprite(0,655,windowWidth*10,20);
...
mine= createSprite(440,650,40,40);
mine.addImage(mineimg);
mine.scale=0.06;


mine2= createSprite(940,500+150,40,40);
mine2.addImage(mineimg);
mine2.scale=0.06;

mine3= createSprite(1880,350+150,40,40);
mine3.addImage(mineimg);
mine3.scale=0.06;


mine4= createSprite(1040,100+150,40,40);
mine4.addImage(mineimg);
mine4.scale=0.06;


mine5= createSprite(2140,100+150,40,40);
mine5.addImage(mineimg);
mine5.scale=0.06;


mine6= createSprite(2200,490+150,40,40);
mine6.addImage(mineimg);
mine6.scale=0.06;


mine7= createSprite(2700,490+150,40,40);
mine7.addImage(mineimg);
mine7.scale=0.06;

mine8= createSprite(2880,100+150,40,40);
mine8.addImage(mineimg);
mine8.scale=0.06;


mine9= createSprite(3000,100+150,40,40);
mine9.addImage(mineimg);
mine9.scale=0.06;


mine10= createSprite(3240,150+150,40,40);
...
pillar=createSprite(300,435+150,40,100)
pillar.addImage(pillarimg);
pillar.scale=0.2;


pillar2=createSprite(800,435+150,40,100)
pillar2.addImage(pillarimg);
pillar2.scale=0.2


pillar3=createSprite(900,435+150,40,100)
pillar3.addImage(pillarimg);
pillar3.scale=0.2;


pillar4=createSprite(1400,480+150,40,100)
pillar4.addImage(pillarimg);
pillar4.scale=0.08;


pillar5=createSprite(2400,400+150,40,100)
pillar5.addImage(pillarimg);
pillar5.scale=0.3;


pillar6=createSprite(2200,450+150,40,100)
pillar6.addImage(pillarimg);
pillar6.scale=0.15;
//pillar.debug=true;

pillar7=createSprite(2700,465+150,40,100)
pillar7.addImage(pillarimg);
pillar7.scale=0.11;


pillar8=createSprite(3200,415+150,40,100)
pillar8.addImage(pillarimg);
pillar8.scale=0.25


pillar9=createSprite(3500,435+150,40,100)
pillar9.addImage(pillarimg);
pillar9.scale=0.2;


pillar10=createSprite(3800,480+150,40,100)
pillar10.addImage(pillarimg);
pillar10.scale=0.08;


pillar11=createSprite(4000,400+150,40,100)
pillar11.addImage(pillarimg);
pillar11.scale=0.3;


pillar12=createSprite(3000,450+150,40,100)
pillar12.addImage(pillarimg);
pillar12.scale=0.15;


leftButton = createSprite(mario.x-50,500);
leftButton.addImage(leftimg);
leftButton.scale=0.1

rightbutton = createSprite(mario.x-50,500);
rightbutton.addImage(rightimg);
rightbutton.scale=0.3

jumpbutton = createSprite(mario.x-150,500);
...
function draw() {
 if(gameLevel===LEVEL1){
  ...
  if(keyIsDown(UP_ARROW) && mario.y===597.5 ){
